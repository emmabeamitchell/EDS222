...
## Step 3: Install the following packages, if they are not already installed:[^week1-discussion-(1-1]

[^week1-discussion-(1-1]: Note: This will take a minute or two!
...
## Step 4: Load all the packages you need, plus the `_common.R` source file.[^week1-discussion-(1-2]

[^week1-discussion-(1-2]: Note: If you get a `namespace load` error for `tidyverse`, you want to remove the problem package, reinstall it, and then load `tidyverse` again.
