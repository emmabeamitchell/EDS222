...
(i) the size of crab and latitude: 0.4
...
# not interpretable because size can't be negative
...
# not interpretable because water_temp does not get that hot
```
