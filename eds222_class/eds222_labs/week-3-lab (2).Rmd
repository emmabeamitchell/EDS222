...
# adjusted R square is .347

summary(lm(water_temp ~ latitude, data = pie_crab))
# adjusted R squared is .916

#the adjusted R squared is much higher in water temp, makes sense when looking at data
...
```{r}
residual <- resid(lm(size ~ latitude, data = pie_crab))
sse <- sum(residual^2)
...
# 1999 estimate is 23.4274
# 2008 estimate is 23.4274 + .0256 = 23.453

# beta 1 equals .0256
# beta 0 equals 23.4274
